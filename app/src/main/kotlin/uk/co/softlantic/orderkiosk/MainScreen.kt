...
import uk.co.softlantic.orderkiosk.account.login.AccountScreen
import uk.co.softlantic.orderkiosk.account.personaldetails.MyAccountScreen
import uk.co.softlantic.orderkiosk.account.registration.RegistrationScreen
import uk.co.softlantic.orderkiosk.account.resetpassword.ResetPasswordScreen
import uk.co.softlantic.orderkiosk.bag.BagScreen
import uk.co.softlantic.orderkiosk.checkout.CheckoutScreen
import uk.co.softlantic.orderkiosk.coupons.CouponsScreen
import uk.co.softlantic.orderkiosk.menu.MenuScreen
import uk.co.softlantic.orderkiosk.offers.OffersScreen
import uk.co.softlantic.orderkiosk.orderhistory.OrderHistoryScreen
import uk.co.softlantic.orderkiosk.ordersummary.OrderSummaryScreen
import uk.co.softlantic.orderkiosk.welcome.WelcomeScreen
